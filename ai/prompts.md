...
- **Milestone in progress:** `0.1.0-rc.5` is being cut for Git workspace tools plus VS Code task launchers.
...
- Current milestone: `0.1.0-rc.5` release prep; local build/test passed; macOS packaged smoke runs on tag CI
...
- Backlog: signing / notarization / auto-update only after rc.5 tag/publish completes
- Mac smoke evidence: `docs/verification/macos-smoke-v0.1.0-rc.2.json` from Actions run `31277571206`
- Local verify bar: `npm run build` + `npm run test:ci` (52 Electron / 167 Angular)
