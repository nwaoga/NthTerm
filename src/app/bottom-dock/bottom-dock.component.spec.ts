...
describe('BottomDockComponent', () => {
    const utilityPanelService = {
        ...
        clearOutput: vi.fn().mockName('clearOutput'),
        clearProblems: vi.fn().mockName('clearProblems'),
    };
    ...
    const systemMonitorService = {
        ...
        formatMetric: (value: number | null | undefined, suffix = '') => value === null || value === undefined ? 'n/a' : `${value}${suffix}`,
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            ...
            providers: [
                ...
                { provide: TerminalSessionService, useValue: { rerunCommand: vi.fn().mockName('rerunCommand') } },
                {
    ...
    it('focuses the search input when focusSearchInput is called', async () => {
        vi.useFakeTimers();
        const fixture = TestBed.createComponent(BottomDockComponent);
        utilityPanelService.activeTab = 'output';
        fixture.detectChanges();
    ...
    it('emits a collapse request from the dock header', () => {
        const fixture = TestBed.createComponent(BottomDockComponent);
        const collapseRequested = vi.fn().mockName('collapseRequested');
