...
describe('LeftRailComponent', () => {
    const workspaceService = {
        ...
        startRenameWorkspace: vi.fn().mockName('startRenameWorkspace'),
        cancelRenameWorkspace: vi.fn().mockName('cancelRenameWorkspace'),
    ...
    it('emits workspace selection when a workspace row is clicked', () => {
        ...
        const selectedSpy = vi.fn().mockName('workspaceSelected');
    ...
    it('emits a new workspace request from the new workspace button', () => {
        const fixture = TestBed.createComponent(LeftRailComponent);
        const component = fixture.componentInstance;
        const newSessionSpy = vi.fn().mockName('newSessionRequested');
    ...
    it('emits collapse when the hide workspaces rail button is clicked', () => {
        const fixture = TestBed.createComponent(LeftRailComponent);
        const component = fixture.componentInstance;
        const collapseSpy = vi.fn().mockName('collapseRequested');
